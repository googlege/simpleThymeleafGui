...
public class MainController extends AbstractController {
	...
	private final IPersonFassade personService;

	@Autowired
	public MainController(PersonForm data, MessageComponent messageComponent, ConfigurableEnvironment environment) throws NamingException {
		...
		this.personService = RmiClientUtil.getPersonFassade(port, rmiHost);
	}
	...
	public String personList(Model model, @RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size) throws RemoteException {
	...
	public String showNewPersonPage(Model model, @ModelAttribute("personForm") PersonForm personForm) throws RemoteException {
		int currentPage = 1;
	...
	public String showAddPersonPage(Model model, @RequestParam(required = false) Long selectedPersonId) throws RemoteException {
	...
	public String savePerson(Model model, //
			final RedirectAttributes redirectAttributes, @ModelAttribute("personForm") PersonForm personForm) throws RemoteException {
