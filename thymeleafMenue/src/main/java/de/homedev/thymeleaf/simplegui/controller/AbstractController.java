...
public abstract class AbstractController {
	...
	protected void addSuccessUpdateMessageAndTranslate(final RedirectAttributes redirectAttributes, boolean newEntityFlag) {
		if (newEntityFlag) {
			addSuccessMessageAndTranslate("common.success.new", redirectAttributes);
		} else {
			addSuccessMessageAndTranslate("common.success.update", redirectAttributes);
		}
	}
