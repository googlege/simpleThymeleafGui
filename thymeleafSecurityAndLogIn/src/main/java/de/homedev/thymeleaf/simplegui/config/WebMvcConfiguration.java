...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    private void addHandler(final ResourceHandlerRegistry registry,
                            final AbstractResourceResolver resourceResolver,
                            final String resourceHandler,
                            final String... resourceLocations) {
        registry.addResourceHandler(resourceHandler).addResourceLocations(resourceLocations)
            .setCacheControl(CacheControl.maxAge(MAX_CACHE_AGE, TimeUnit.DAYS).cachePublic()).resourceChain(true)
