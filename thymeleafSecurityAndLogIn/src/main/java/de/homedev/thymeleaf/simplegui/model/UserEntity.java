...
public class UserEntity extends AbstractMandantEntity implements UserDetails {
    ...
    public String toString() {
        return "UserEntity [id=" + id + ", username=" + username + ", password=" + password + ", deleted=" + isDeleted()
            + ", version=" + getVersion() + ", userRole=" + role + "]";
    }

    @Override
    public List<UserRoleEntity> getAuthorities() {

        List<UserRoleEntity> result = new ArrayList<UserRoleEntity>(1);
